...
public:
    ...
    static QString requestDocDatoUri(connection_to_server *connection, int userId, QString uri);       // FILE
    ...
    static std::shared_ptr<QSet<int>> getContributorsUsersOnDocument(connection_to_server *connection, int docId);
    static void Editor(connection_to_server *connection, CRDT_SharedEditor *crdt);
};
