...
QT_MOC_LITERAL(5, 50, 9) // "runServer"

    },
    "Server\0error\0\0QTcpSocket::SocketError\0"
    "socketError\0runServer"
};
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->runServer(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Server::*)(QTcpSocket::SocketError );
...
// SIGNAL 0
void Server::error(QTcpSocket::SocketError _t1)
{
